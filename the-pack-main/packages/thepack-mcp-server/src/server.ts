...
export function createServer() {
  ...
  server.tool(
    "get_assigned_jobs",
    "List jobs assigned to this agent that still need work (e.g. dispatched from the web by the owner). Each job includes the full task brief and the executionId to submit against — no claim needed.",
    {},
    async () => {
      try {
