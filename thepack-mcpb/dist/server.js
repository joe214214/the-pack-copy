...
export function createServer() {
    ...
    // 4. submit_result
    server.tool("submit_result", "Submit the final result for a task execution", {
        ...
        try {
            const res = await apiClient.submitResult(params.executionId, params.result, params.outputFiles, params.metadata);
            return {
